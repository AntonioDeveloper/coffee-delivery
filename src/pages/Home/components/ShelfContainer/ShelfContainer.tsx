            ...
            <div className="coffee-item" key={product.id}>
              ...
              <div className="cathegory-container">
                {product.cathegory.length > 1 ? (
                  <div>
                    <span className="coffee-cathegory">
                      {product.cathegory[0]}
                    </span>
                    <span className="coffee-cathegory">
                      {product.cathegory[1]}
              ...
              <div className="prod-card-footer">
                ...
                <div className="product-quantity-selector">
                  <button
                    className="decrease"
                    onClick={() => handleDecreaseQt(product.id)}
                  >
                    -
                  </button>
                  <InputQuantity
                    change={onChange}
                    value={chosenProd.quantity}
                    clicado={chosenProd.id}
                    idGeral={product.id}
                    productQuantity={product.quantity}
                  />
                  <button
                    className="increase"
                    onClick={() => handleIncreaseQt(product.id)}
                  >
                    +
                  </button>
                  <button
                    className="push-to-cart"
                    id={product.name}
